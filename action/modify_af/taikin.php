...
<body id="modify_af">
  ...
  <div class="comment">退勤時間の変更を行います。</div>
  ...
  <form action="./taikin.php" method="get" onSubmit="return checkSubmit()">
    <?php if ($_GET["finish_time"] == "") { ?>
      <input type="datetime-local" name="time" step="60" value="<?php echo ($_GET["date"] . 'T' . 19 . ":" . 0 . 0); ?>" class="form"><br>
    <?php } else { ?>
      <input type="datetime-local" name="time" step="60" value="<?php echo str_replace(' ', 'T', $_GET["finish_time"]); ?>" class="form"><br>
    <?php } ?>
